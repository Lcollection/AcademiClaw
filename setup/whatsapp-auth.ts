...
<html><head><title>AcademiClaw - WhatsApp Auth</title>
...
<script>
  var startKey = 'academiclaw_qr_start';
...
<html><head><title>AcademiClaw - Connected!</title>
<style>
...
<script>localStorage.removeItem('academiclaw_qr_start');</script>
</body></html>`;
